...
public class Score2 {
    public static void main(String[] args) {
        ...
        final int MIN_SCORE = 0; // 점수의 최소값
        final int MAX_SCORE = 100; // 점수의 최대값
        int numStudents;
        int sum = 0;
        int maxScore = 0;
        ...
        for (int i = 0; i < numStudents; i++) {
            System.out.print(i + "번째 학생의 실습 점수: ");
            int score = sc.nextInt();

            // 입력받은 점수가 유효한 범위인지 검사하는 조건문 작성 (단, MIN_SCORE, MAX_SCORE 활용)
